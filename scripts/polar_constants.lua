...
POLARWALRUS_TRADEDATA = {
	walrus = {
		...
		{product = "goldnugget", 		ingredients = {Ingredient("trunk_winter", 1)}, 		limit = 12, numtogive = 5},
		{product = "walrushat",		 	ingredients = {Ingredient("polarbearfur", 2)}, 		limit = 1},
	},
	little_walrus = {
		{product = "smallmeat", 		ingredients = {Ingredient("ice", 2)}, 				limit = 8, restock = 4},
		...
		{product = "trunk_winter", 		ingredients = {Ingredient("saltrock", 5)}, 			limit = 1},
	},
	girl_walrus = {
		...
		{product = "cookingrecipecard", 	ingredients = {Ingredient("goldnugget", 1)}, 		limit = 1, nosharedstock = true, nameoverride = "cookingrecipecard_koalefried_trunk_summer", image = "cookingrecipecard.tex"},
		{product = "cookingrecipecard", 	ingredients = {Ingredient("goldnugget", 1)}, 		limit = 1, nosharedstock = true, nameoverride = "cookingrecipecard_koalefried_trunk_winter", image = "cookingrecipecard.tex"},
	},
}
