...
--	Speech, etc
	...
	STRINGS.POLARBEAR_IN_COMBAT_TRIAL = {"FIGHT!", "HAHA!", "RAAAWRRRRRRRR!", "COME! HIT ME!", "I'LL GET YOU!", "FIGHT LIKE A BEAR!", "SHOW ME WHAT YOU GOT!", "FIGHT ME!"}
	STRINGS.POLARBEAR_IN_FUN_TRIAL = {"FUN!"}
	STRINGS.POLARBEAR_SPECTATING_COMBAT_TRIAL = {"FIGHT, FIGHT!", "GET THEM!", "HAHA, YES!", "THIS IS FUN!", "PLAY FAIR", "NO PENGULLING OUT NOW!", "ME NEXT!"}
	STRINGS.POLARBEAR_SPECTATING_FUN_TRIAL = {"FUN!"}
	...
	STRINGS.POLARBEAR_FACE_MAJOR_GUILTY = {"YES SIR!", "MAJOR RIGHT, WON'T DO IT AGAIN", "SORRY! SORRY!", "DID NOT MEAN TO"}
	STRINGS.POLARBEAR_FACE_MAJOR_GENERIC = {"MAJOR ANGRY!", "BAD BEAR MANNERS", "MAJOR RIGHT!", "COMING! COMING!", "DON'T FIGHT!"}
...
--	UI
	...
	STRINGS.SCRAPBOOK.SPECIALINFO.POLARFOX = "Can be tempted into following us by leaving meat close enough from them. They will often bury themselves in the snow to dig out vulnerable preys, or to hide from blizzards."
	...
	RECIPE_DESC.POLAR_TRADE_1 = "...found those around... it's yourrrs, for a price..."
	RECIPE_DESC.POLAR_TRADE_2 = "...mined those... when you werrren't watching..."
	...
	STRINGS.UI.CRAFTING_STATION_FILTERS.POLARBEARKING_TRIALS = "Ursa's Trials"
	...
	STRINGS.UI.SANDBOXMENU.THRONE_REFRESH = "Yearly Refresh"
	
	STRINGS.UI.CUSTOMIZATIONSCREEN.ANTLER_TREES_REGROWTH = "Bullbarks"
