...
--	Worldgen
	...
	DESCRIBE.ANTLER_TREE = {
		BURNING = "Did you see it coming? I bet not!",
		BURNT = "It took a creepy and crispy turn.",
	...
	--	Rocks and stones
	DESCRIBE.POLAR_ICICLE = "I swear it flinched! Or have I been deceived?"
	DESCRIBE.POLAR_ICICLE_ROCK = "You should have taken your chances earlier or later."
	DESCRIBE.ROCK_POLAR = "Are those gems I spy under the chilly mist?"
