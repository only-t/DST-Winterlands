...
--	Items
	...
	TUNING.WALRUS_BEARTRAP_AUTOSTRUGGLE_TIMES = {min = 1, max = 3, lastattacked = 2}
...
--	Misc
	...
	TUNING.HUNT_KOALEFANT_POLAR_CHANCE = TUNING.HUNT_ALTERNATE_BEAST_CHANCE_MAX -- Winter Koalefant may spawn in autumn/spring
