...
--	Mobs
	...
	TUNING.POLARFLEA_MOTHER_HEALTH = 2500
	TUNING.POLARFLEA_MOTHER_DAMAGE = 30
	TUNING.POLARFLEA_MOTHER_TONGUE_DAMAGE = 17
	TUNING.POLARFLEA_MOTHER_RUN_SPEED = 6
	TUNING.POLARFLEA_MOTHER_WALK_SPEED = 3
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWN_COOLDOWN = 9
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWN_DIST = 12
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWN_MAX = 10
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWNCHANCE_DECAY = 0.1
	TUNING.POLARFLEA_MOTHER_FLEAS_SPAWNCHANCE_KILL = 0.01
	TUNING.POLARFLEA_MOTHER_SPAWN_CHANCE = 0
	TUNING.POLARFLEA_MOTHER_SPAWN_CHANCE_MIN = 0.1
...
--	Items
	...
	TUNING.ICELETTUCE_COOLER = -10 -- Heater
	TUNING.ICELETTUCE_COOLING = -5 -- Eaten
